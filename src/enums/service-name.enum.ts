export enum ServiceNameEnum {
  ...
  DISCORD_DM_FIREBASE_SERVICE = `DiscordDmFirebaseService`,
  ...
  DISCORD_MESSAGE_COMMAND_HEARTBEAT_UPDATE_ERROR_SERVICE = `DiscordMessageCommandHeartbeatUpdateErrorService`,
  ...
  DISCORD_MESSAGE_SUB_COMMAND_VERIFY_CHANNEL_RIGHT_SERVICE = `DiscordMessageSubCommandVerifyChannelRightService`,
  DISCORD_MESSAGE_COMMAND_VERIFY_CHANNEL_RIGHT_WARNING_UNSUPPORTED_CHANNEL_TYPE_SERVICE = `DiscordMessageCommandVerifyChannelRightWarningUnsupportedChannelTypeService`,
  ...
  FIREBASE_STORE_SERVICE = `FirebaseStoreService`,
  ...
  FIREBASE_DMS_BREAKING_CHANGE_SERVICE = `FirebaseDmsBreakingChangeService`,
  FIREBASE_DMS_FEATURES_NOON_ENABLED_SERVICE = `FirebaseDmsFeaturesNoonEnabledService`,
  FIREBASE_DMS_FEATURES_NOON_ENABLED_STATE_SERVICE = `FirebaseDmsFeaturesNoonEnabledStateService`,
  FIREBASE_DMS_FEATURES_NOON_SERVICE = `FirebaseDmsFeaturesNoonService`,
  FIREBASE_DMS_FEATURES_RELEASE_NOTES_ENABLED_SERVICE = `FirebaseDmsFeaturesReleaseNotesEnabledService`,
  FIREBASE_DMS_FEATURES_RELEASE_NOTES_ENABLED_STATE_SERVICE = `FirebaseDmsFeaturesReleaseNotesEnabledStateService`,
  FIREBASE_DMS_FEATURES_RELEASE_NOTES_SERVICE = `FirebaseDmsFeaturesReleaseNotesService`,
  FIREBASE_DMS_FEATURES_SERVICE = `FirebaseDmsFeaturesService`,
  FIREBASE_DMS_NEW_VERSION_COUNT_HUMANIZED_SERVICE = `FirebaseDmsNewVersionCountHumanizedService`,
  FIREBASE_DMS_NEW_VERSION_COUNT_MESSAGE_RESPONSE_SERVICE = `FirebaseDmsNewVersionCountMessageResponseService`,
  FIREBASE_DMS_NEW_VERSION_COUNT_SERVICE = `FirebaseDmsNewVersionCountService`,
  FIREBASE_DMS_NEW_VERSION_SERVICE = `FirebaseDmsNewVersionService`,
  FIREBASE_DMS_SERVICE = `FirebaseDmsService`,
  FIREBASE_DMS_STORE = `FirebaseDmsStore`,
  FIREBASE_DMS_STORE_QUERY = `FirebaseDmsStoreQuery`,
  FIREBASE_DMS_STORE_SERVICE = `FirebaseDmsStoreService`,
