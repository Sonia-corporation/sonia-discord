...
describe(`DiscordMessageCommandFeatureErrorService`, (): void => {
  ...
  describe(`getWrongFeatureNameErrorMessageResponse()`, (): void => {
    let anyDiscordMessage: IAnyDiscordMessage;
    let commands: DiscordMessageCommandEnum[];
    ...
    it(`should get the CLI error message response`, async (): Promise<void> => {
      ...
      await service.getWrongFeatureNameErrorMessageResponse(
        anyDiscordMessage,
        commands,
        featureName
      );
    ...
    > => {
      ...
      const result = await service.getWrongFeatureNameErrorMessageResponse(
        anyDiscordMessage,
        commands,
        featureName
      );
