import { DISCORD_MESSAGE_COMMAND_FEATURE_RELEASE_NOTES_FLAGS } from './discord-message-command-feature-release-notes-flags';
...
describe(`DISCORD_MESSAGE_COMMAND_FEATURE_RELEASE_NOTES_FLAGS`, (): void => {
  it(`should be the feature command flags list`, (): void => {
    expect.assertions(1);

    expect(DISCORD_MESSAGE_COMMAND_FEATURE_RELEASE_NOTES_FLAGS).toStrictEqual(
