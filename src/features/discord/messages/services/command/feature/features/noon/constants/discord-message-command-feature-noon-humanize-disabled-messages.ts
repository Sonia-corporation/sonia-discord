...
export const DISCORD_MESSAGE_COMMAND_FEATURE_NOON_HUMANIZE_DISABLED_MESSAGES: Messages<DiscordMessageCommandFeatureNoonHumanizeDisabledMessagesEnum> = new Messages<
