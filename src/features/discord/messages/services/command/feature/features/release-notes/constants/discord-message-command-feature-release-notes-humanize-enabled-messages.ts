...
export const DISCORD_MESSAGE_COMMAND_FEATURE_RELEASE_NOTES_HUMANIZE_ENABLED_MESSAGES: Messages<DiscordMessageCommandFeatureReleaseNotesHumanizeEnabledMessagesEnum> =
