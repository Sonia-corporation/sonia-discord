...
export const DISCORD_MESSAGE_COMMAND_LUNCH_DESCRIPTION_MESSAGES: Messages<DiscordMessageCommandLunchDescriptionEnum> = new Messages<
  DiscordMessageCommandLunchDescriptionEnum
>({
