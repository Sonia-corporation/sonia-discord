...
export const DISCORD_MESSAGE_COMMAND_COOKIE_TITLE_MESSAGES: Messages<DiscordMessageCommandCookieTitleEnum> = new Messages<
  DiscordMessageCommandCookieTitleEnum
>({
