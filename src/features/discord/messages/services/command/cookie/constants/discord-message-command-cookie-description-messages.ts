...
export const DISCORD_MESSAGE_COMMAND_COOKIE_DESCRIPTION_MESSAGES: Messages<DiscordMessageCommandCookieDescriptionEnum> = new Messages<DiscordMessageCommandCookieDescriptionEnum>(
  {
