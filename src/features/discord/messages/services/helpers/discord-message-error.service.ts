...
export class DiscordMessageErrorService extends DiscordCommandErrorCoreService {
  ...
  private _getMessageEmbedFields(error: unknown, anyDiscordMessage: IAnyDiscordMessage): EmbedField[] {
    return [
  ...
  private _getMessageEmbedFieldMessageId({ id }: IAnyDiscordMessage): EmbedField {
    return {
  ...
  private _getMessageEmbedFieldError(error: unknown): EmbedField {
    return {
      name: `My blood trace`,
