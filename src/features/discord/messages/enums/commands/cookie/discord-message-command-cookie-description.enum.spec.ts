...
describe(`DiscordMessageCommandCookieDescriptionEnum`, (): void => {
  it(`should have a member "BETTER_THAN_COOKIE_CLICKER"`, (): void => {
    ...
    expect(
      DiscordMessageCommandCookieDescriptionEnum.BETTER_THAN_COOKIE_CLICKER
    ).toStrictEqual(
  ...
  it(`should have a member "CALL_911_THIS_IS_TOO_GOOD"`, (): void => {
    ...
    expect(
      DiscordMessageCommandCookieDescriptionEnum.CALL_911_THIS_IS_TOO_GOOD
    ).toStrictEqual(`Call 911, this is too good.`);
  });
  ...
  it(`should have a member "CALL_ME_LEGEND"`, (): void => {
    ...
    expect(
      DiscordMessageCommandCookieDescriptionEnum.CALL_ME_LEGEND
    ).toStrictEqual(`Call me Legend.`);
  });
  ...
  it(`should have a member "CHUCK_NORRIS_CAN_NOT_BEAT_ME"`, (): void => {
    ...
    ).toStrictEqual(`Chuck Norris can't beat me.`);
  });

  it(`should have a member "DAMN_GOOD"`, (): void => {
    expect.assertions(1);

    expect(DiscordMessageCommandCookieDescriptionEnum.DAMN_GOOD).toStrictEqual(
      `Damn good!`
    );
  });
  ...
  it(`should have a member "DO_NOT_WORRY"`, (): void => {
    ...
    expect(
      DiscordMessageCommandCookieDescriptionEnum.DO_NOT_WORRY
    ).toStrictEqual(`Do not worry.`);
  });
  ...
  it(`should have a member "ENJOY"`, (): void => {
    ...
    expect(DiscordMessageCommandCookieDescriptionEnum.ENJOY).toStrictEqual(
      `Enjoy!`
    );
  });
  ...
  it(`should have a member "ENJOY_THEM"`, (): void => {
    ...
    expect(DiscordMessageCommandCookieDescriptionEnum.ENJOY_THEM).toStrictEqual(
      `Enjoy them!`
    );
  });
  ...
  it(`should have a member "GODLIKE"`, (): void => {
    ...
    expect(DiscordMessageCommandCookieDescriptionEnum.GODLIKE).toStrictEqual(
      `Godlike.`
    );
  });
  ...
  it(`should have a member "HEART"`, (): void => {
    ...
    expect(DiscordMessageCommandCookieDescriptionEnum.HEART).toStrictEqual(
      `:heart:`
    );
  });
  ...
  it(`should have a member "HEARTS"`, (): void => {
    ...
    expect(DiscordMessageCommandCookieDescriptionEnum.HEARTS).toStrictEqual(
      `:hearts:`
    );
  });
  ...
  it(`should have a member "I_AM_HERE_FOR_YOU"`, (): void => {
    ...
    expect(
      DiscordMessageCommandCookieDescriptionEnum.I_AM_HERE_FOR_YOU
    ).toStrictEqual(`I am here for you!`);
  });
  ...
  it(`should have a member "I_COVER_YOU"`, (): void => {
    ...
    expect(
      DiscordMessageCommandCookieDescriptionEnum.I_COVER_YOU
    ).toStrictEqual(`I cover you!`);
  });
  ...
  it(`should have a member "I_GOT_YOUR_BACK"`, (): void => {
    ...
    expect(
      DiscordMessageCommandCookieDescriptionEnum.I_GOT_YOUR_BACK
    ).toStrictEqual(`I got your back!`);
  });
  ...
  it(`should have a member "I_JUST_KILLED_THE_GAME"`, (): void => {
    ...
    expect(
      DiscordMessageCommandCookieDescriptionEnum.I_JUST_KILLED_THE_GAME
    ).toStrictEqual(`I just killed the game!`);
  });
  ...
  it(`should have a member "I_ROCK_SO_HARD"`, (): void => {
    ...
    expect(
      DiscordMessageCommandCookieDescriptionEnum.I_ROCK_SO_HARD
    ).toStrictEqual(`I rock so hard!`);
  });
  ...
  it(`should have a member "IT_WAS_MY_PLEASURE"`, (): void => {
    ...
    expect(
      DiscordMessageCommandCookieDescriptionEnum.IT_WAS_MY_PLEASURE
    ).toStrictEqual(`It was my pleasure.`);
  });
  ...
  it(`should have a member "LOVE_THEM_TOO"`, (): void => {
    ...
    expect(
      DiscordMessageCommandCookieDescriptionEnum.LOVE_THEM_TOO
    ).toStrictEqual(`I love them too :yum:`);
  });
  ...
  it(`should have a member "THIS_IS_FREE"`, (): void => {
    ...
    expect(
      DiscordMessageCommandCookieDescriptionEnum.THIS_IS_FREE
    ).toStrictEqual(`This is free.`);
  });
  ...
  it(`should have a member "THIS_IS_SO_FUCKING_GREAT"`, (): void => {
    ...
    expect(
      DiscordMessageCommandCookieDescriptionEnum.THIS_IS_SO_FUCKING_GREAT
    ).toStrictEqual(`This is so fucking great!`);
  });

  it(`should have a member "YES"`, (): void => {
    expect.assertions(1);

    expect(DiscordMessageCommandCookieDescriptionEnum.YES).toStrictEqual(
      `Yes.`
    );
  });
  ...
  it(`should have a member "YOU_WERE_SO_SKINNY_THOUGH"`, (): void => {
    ...
    expect(
      DiscordMessageCommandCookieDescriptionEnum.YOU_WERE_SO_SKINNY_THOUGH
    ).toStrictEqual(`You were so skinny though.`);
  });
});
