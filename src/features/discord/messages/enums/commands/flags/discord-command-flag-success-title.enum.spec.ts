...
describe(`DiscordCommandFlagSuccessTitleEnum`, (): void => {
  it(`should have a member "NOON_FEATURE_DISABLED"`, (): void => {
    ...
    expect(
      DiscordCommandFlagSuccessTitleEnum.NOON_FEATURE_DISABLED
    ).toStrictEqual(`Noon feature disabled`);
  });
  ...
  it(`should have a member "NOON_FEATURE_ENABLED"`, (): void => {
    ...
    expect(
      DiscordCommandFlagSuccessTitleEnum.NOON_FEATURE_ENABLED
    ).toStrictEqual(`Noon feature enabled`);
  });
});
