...
describe(`DiscordCommandValuelessFlag`, (): void => {
  ...
  describe(`constructor()`, (): void => {
    describe(`when the class is created with an action`, (): void => {
      it(`should update the action inside the class`, (): void => {
        expect.assertions(1);
        const action = createHydratedMock<DiscordCommandFlagActionValueless<DummyFlagEnum>>({
        ...
        discordCommandFlag = new DiscordCommandValuelessFlag<DummyFlagEnum>(
          createHydratedMock<IDiscordCommandFlag<DummyFlagEnum, DiscordCommandFlagActionValueless<DummyFlagEnum>>>({
            action,
          })
        );
  ...
  describe(`executeAction()`, (): void => {
    ...
    beforeEach((): void => {
      ...
      messageFlag = `--alpha-flag`;
      discordCommandFlags = createHydratedMock<DiscordCommandFlags<DummyFlagEnum>>();
