...
describe(`DiscordGuildConfigMutatorService`, (): void => {
  ...
  describe(`getInstance()`, (): void => {
    ...
    it(`should create a DiscordGuildConfigMutator service`, (): void => {
      ...
      expect(service).toStrictEqual(expect.any(DiscordGuildConfigMutatorService));
    });
  ...
  describe(`constructor()`, (): void => {
    ...
    describe(`when the given config is undefined`, (): void => {
      ...
      it(`should not update the current send cookies on create state`, (): void => {
        ...
        expect(discordGuildConfigCoreService.shouldSendCookiesOnCreate).toBeTrue();
      });

      it(`should not update the current send noon message state`, (): void => {
        expect.assertions(1);
        discordGuildConfigCoreService.shouldSendNoonMessage = true;

        service = new DiscordGuildConfigMutatorService(config);

        expect(discordGuildConfigCoreService.shouldSendNoonMessage).toBeTrue();
      });
      ...
      it(`should not update the current welcome new members state`, (): void => {
        ...
        expect(discordGuildConfigCoreService.shouldWelcomeNewMembers).toBeTrue();
      });
    ...
    describe(`when the given config is a complete object`, (): void => {
      ...
      it(`should override the send noon message state`, (): void => {
        expect.assertions(1);
        discordGuildConfigCoreService.shouldSendNoonMessage = false;
  ...
  describe(`preUpdateConfig()`, (): void => {
    ...
    beforeEach((): void => {
      ...
      discordGuildConfigCoreServiceGetInstanceSpy = jest.spyOn(DiscordGuildConfigCoreService, `getInstance`);
      discordGuildConfigServiceGetInstanceSpy = jest.spyOn(DiscordGuildConfigService, `getInstance`);
    });
    ...
    it(`should create the DiscordGuildConfigCore service instance`, (): void => {
      ...
      expect(discordGuildConfigCoreServiceGetInstanceSpy).toHaveBeenCalledOnce();
      expect(discordGuildConfigCoreServiceGetInstanceSpy).toHaveBeenCalledWith();
    });
    ...
    it(`should create the DiscordGuildConfig service instance`, (): void => {
      ...
      expect(discordGuildConfigServiceGetInstanceSpy).toHaveBeenCalledOnce();
  ...
  describe(`updateConfig()`, (): void => {
    ...
    describe(`when the given config contains a guild send cookies on create state`, (): void => {
      ...
      it(`should update the config send cookie on create state`, (): void => {
        ...
        expect(discordGuildConfigCoreService.shouldSendCookiesOnCreate).toBeFalse();
      });
    ...
    describe(`when the given config contains a guild send noon message state`, (): void => {
      beforeEach((): void => {
        config = {
          guild: {
            shouldSendNoonMessage: false,
          },
        };
      });

      it(`should update the config send noon message state`, (): void => {
        expect.assertions(1);

        service.updateConfig(config);

        expect(discordGuildConfigCoreService.shouldSendNoonMessage).toBeFalse();
      });
    ...
    describe(`when the given config contains a guild welcome new members state`, (): void => {
      ...
      it(`should update the config welcome new members state`, (): void => {
        ...
        expect(discordGuildConfigCoreService.shouldWelcomeNewMembers).toBeFalse();
      });
  ...
  describe(`updateGuild()`, (): void => {
    ...
    describe(`when the given config contains a send noon message state`, (): void => {
      beforeEach((): void => {
        config = {
          shouldSendNoonMessage: false,
        };
  ...
  describe(`updateSendNoonMessageState()`, (): void => {
    let shouldSendNoonMessage: boolean;
    ...
    it(`should get the updated boolean`, (): void => {
      ...
      service.updateSendNoonMessageState(shouldSendNoonMessage);
      ...
      expect(configServiceGetUpdatedBooleanSpy).toHaveBeenCalledWith({
        ...
        newValue: true,
        oldValue: false,
        valueName: `send noon message state`,
      } as IConfigUpdateBoolean);
    });

    it(`should update the Discord guild config send noon message state with the updated boolean`, (): void => {
      expect.assertions(1);
