...
jest.mock(`firebase-admin`, (): unknown => {
  return {
    credential: {},
    firestore: jest.fn().mockReturnValue(createHydratedMock<admin.firestore.Firestore>()),
  };
});
...
describe(`FirebaseGuildsService`, (): void => {
  ...
  describe(`init()`, (): void => {
    ...
    beforeEach((): void => {
      service = new FirebaseGuildsService();
      app = createHydratedMock<admin.app.App>();
      ...
      firestoreSpy = jest.spyOn(admin, `firestore`).mockReturnValue(
        createHydratedMock<admin.firestore.Firestore>({
  ...
  describe(`getCollectionReference()`, (): void => {
    ...
    beforeEach((): void => {
      ...
      firestore = createHydratedMock<admin.firestore.Firestore>({
  ...
  describe(`getGuilds()`, (): void => {
    ...
    beforeEach((): void => {
      service = new FirebaseGuildsService();
      querySnapshot = createHydratedMock<admin.firestore.QuerySnapshot<IFirebaseGuild>>();
      collectionReference = createHydratedMock<admin.firestore.CollectionReference<IFirebaseGuild>>({
  ...
  describe(`hasGuild()`, (): void => {
    ...
    beforeEach((): void => {
      ...
      documentSnapshot = createHydratedMock<admin.firestore.DocumentSnapshot<IFirebaseGuild>>();
      getMock = jest
        .fn<Promise<admin.firestore.DocumentSnapshot<IFirebaseGuild>>, IFirebaseGuild[]>()
        .mockResolvedValue(documentSnapshot);
      documentReference = createHydratedMock<admin.firestore.DocumentReference<IFirebaseGuild>>({
        get: getMock,
      });
      docMock = jest
  ...
  describe(`addGuild()`, (): void => {
    ...
    beforeEach((): void => {
      ...
      documentReference = createHydratedMock<admin.firestore.DocumentReference<IFirebaseGuildVFinal>>({
        set: setMock,
      });
      docMock = jest
        .fn<admin.firestore.DocumentReference<IFirebaseGuildVFinal>, string[]>()
        .mockReturnValue(documentReference);
      collectionReference = createHydratedMock<admin.firestore.CollectionReference<IFirebaseGuildVFinal>>({
        doc: docMock,
      });
  ...
  describe(`getBatch()`, (): void => {
    ...
    beforeEach((): void => {
      service = new FirebaseGuildsService();
      writeBatch = createHydratedMock<admin.firestore.WriteBatch>();
  ...
  describe(`watchGuilds()`, (): void => {
    ...
    beforeEach((): void => {
      service = new FirebaseGuildsService();
      firebaseGuild = createHydratedMock<IFirebaseGuild>();
      queryDocumentSnapshot = createHydratedMock<admin.firestore.QueryDocumentSnapshot<IFirebaseGuild>>({
