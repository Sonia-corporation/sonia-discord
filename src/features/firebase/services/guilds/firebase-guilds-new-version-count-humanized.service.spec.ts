      ...
      describe(`when the guild count is 0`, (): void => {
        ...
        describe(`when the channel count is 1`, (): void => {
          ...
          it(`should return that no release note message was sent`, (): void => {
            ...
            expect(result).toBe(`value-1 release note message sent over value-0 of value-1 guild`);
          });
        });
        ...
        describe(`when the channel count is 2`, (): void => {
          ...
          it(`should return that no release note message was sent`, (): void => {
            ...
            expect(result).toBe(`value-2 release note messages sent over value-0 of value-1 guild`);
          });
        });
      });
      ...
      describe(`when the guild count is 1`, (): void => {
        ...
        describe(`when the channel count is 1`, (): void => {
          ...
          it(`should return that no release note message was sent`, (): void => {
            ...
            expect(result).toBe(`value-1 release note message sent over value-1 of value-1 guild`);
          });
        });
        ...
        describe(`when the channel count is 2`, (): void => {
          ...
          it(`should return that no release note message was sent`, (): void => {
            ...
            expect(result).toBe(`value-2 release note messages sent over value-1 of value-1 guild`);
          });
        });
      });
      ...
      describe(`when the guild count is 2`, (): void => {
        ...
        describe(`when the channel count is 1`, (): void => {
          ...
          it(`should return that no release note message was sent`, (): void => {
            ...
            expect(result).toBe(`value-1 release note message sent over value-2 of value-1 guild`);
          });
        });
        ...
        describe(`when the channel count is 2`, (): void => {
          ...
          it(`should return that no release note message was sent`, (): void => {
            ...
            expect(result).toBe(`value-2 release note messages sent over value-2 of value-1 guild`);
          });
        });
      });
    });
      ...
      describe(`when the guild count is 0`, (): void => {
        ...
        describe(`when the channel count is 1`, (): void => {
          ...
          it(`should return that no release note message was sent`, (): void => {
            ...
            expect(result).toBe(`value-1 release note message sent over value-0 of value-2 guilds`);
          });
        });
        ...
        describe(`when the channel count is 2`, (): void => {
          ...
          it(`should return that no release note message was sent`, (): void => {
            ...
            expect(result).toBe(`value-2 release note messages sent over value-0 of value-2 guilds`);
          });
        });
      });
      ...
      describe(`when the guild count is 1`, (): void => {
        ...
        describe(`when the channel count is 1`, (): void => {
          ...
          it(`should return that no release note message was sent`, (): void => {
            ...
            expect(result).toBe(`value-1 release note message sent over value-1 of value-2 guilds`);
          });
        });
        ...
        describe(`when the channel count is 2`, (): void => {
          ...
          it(`should return that no release note message was sent`, (): void => {
            ...
            expect(result).toBe(`value-2 release note messages sent over value-1 of value-2 guilds`);
          });
        });
      });
      ...
      describe(`when the guild count is 2`, (): void => {
        ...
        describe(`when the channel count is 1`, (): void => {
          ...
          it(`should return that no release note message was sent`, (): void => {
            ...
            expect(result).toBe(`value-1 release note message sent over value-2 of value-2 guilds`);
          });
        });
        ...
        describe(`when the channel count is 2`, (): void => {
          ...
          it(`should return that no release note message was sent`, (): void => {
            ...
            expect(result).toBe(`value-2 release note messages sent over value-2 of value-2 guilds`);
          });
        });
      });
    });
