...
describe(`AppConfigMutationService`, (): void => {
  ...
  describe(`constructor()`, (): void => {
    ...
    describe(`when the given config is undefined`, (): void => {
      ...
      it(`should not update the current first release date`, (): void => {
        ...
        expect(appConfigCoreService.firstReleaseDate).toBe(`firstReleaseDate`);
      });
      ...
      it(`should not update the current initialization date`, (): void => {
        ...
        expect(appConfigCoreService.initializationDate).toBe(`initializationDate`);
      });
      ...
      it(`should not update the current release date`, (): void => {
        ...
        expect(appConfigCoreService.releaseDate).toBe(`releaseDate`);
      });
      ...
      it(`should not update the current release notes`, (): void => {
        ...
        expect(appConfigCoreService.releaseNotes).toBe(`releaseNotes`);
      });
      ...
      it(`should not update the current version`, (): void => {
        ...
        expect(appConfigCoreService.version).toBe(`version`);
      });
    });
    ...
    describe(`when the given config is a complete object`, (): void => {
      ...
      it(`should override the release type`, (): void => {
        ...
        expect(appConfigCoreService.releaseType).toStrictEqual(AppConfigReleaseTypeEnum.UNKNOWN);
      });
      ...
      it(`should override the version`, (): void => {
        ...
        expect(appConfigCoreService.version).toBe(`dummy-version`);
      });
    });
  });
  ...
  describe(`init()`, (): void => {
    ...
    beforeEach((): void => {
      ...
      isNodeProductionSpy = jest.spyOn(IsNodeProductionModule, `isNodeProduction`);
    });
    ...
    describe(`when the app is running on production`, (): void => {
      ...
      it(`should not update the config initialization date`, (): void => {
        ...
        expect(appConfigCoreService.initializationDate).toBe(`today`);
      });
    });
    ...
    describe(`when the app is not running on production`, (): void => {
      ...
      it(`should update the config initialization date to now`, (): void => {
        ...
        expect(appConfigCoreService.initializationDate).toBe(`now`);
      });
    });
  ...
  describe(`preUpdateConfig()`, (): void => {
    ...
    beforeEach((): void => {
      ...
      appConfigCoreServiceGetInstanceSpy = jest.spyOn(AppConfigCoreService, `getInstance`);
      appConfigServiceGetInstanceSpy = jest.spyOn(AppConfigService, `getInstance`);
    });
  ...
  describe(`updateConfig()`, (): void => {
    ...
    beforeEach((): void => {
      ...
      releaseTypeServiceGetReleaseTypeSpy = jest.spyOn(releaseTypeService, `getReleaseType`).mockImplementation();
    });
    ...
    describe(`when the given config contains a first release date`, (): void => {
      ...
      it(`should update the config first release date`, (): void => {
        ...
        expect(appConfigCoreService.firstReleaseDate).toBe(`first-release-date`);
      });
    ...
    describe(`when the given config contains an initialization date`, (): void => {
      ...
      it(`should update the config initialization date`, (): void => {
        ...
        expect(appConfigCoreService.initializationDate).toBe(`initialization-date`);
      });
    ...
    describe(`when the given config contains a release date`, (): void => {
      ...
      it(`should update the config release date`, (): void => {
        ...
        expect(appConfigCoreService.releaseDate).toBe(`release-date`);
      });
    ...
    describe(`when the given config contains a release notes`, (): void => {
      beforeEach((): void => {
        ...
        releaseTypeServiceGetReleaseTypeSpy.mockReturnValue(AppConfigReleaseTypeEnum.PERFORMANCE_IMPROVEMENTS);
      });
      ...
      it(`should update the config release notes`, (): void => {
        ...
        expect(appConfigCoreService.releaseNotes).toBe(`release-notes`);
      });

      it(`should update the config release type`, (): void => {
        expect.assertions(1);

        service.updateConfig(config);

        expect(appConfigCoreService.releaseType).toStrictEqual(AppConfigReleaseTypeEnum.PERFORMANCE_IMPROVEMENTS);
      });
  ...
  describe(`updateReleaseNotes()`, (): void => {
    ...
    beforeEach((): void => {
      ...
      configServiceGetUpdatedStringSpy = jest
        ...
        .mockReturnValueOnce(`dummy-release-notes`)
        .mockReturnValueOnce(AppConfigReleaseTypeEnum.BUG_FIXES);
    ...
    it(`should update the app config release type with the updated type`, (): void => {
      expect.assertions(1);
